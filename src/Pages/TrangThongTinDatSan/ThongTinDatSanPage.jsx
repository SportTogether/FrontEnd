            ...
            <div className="container grid grid-cols-2 gap-8">
                <div className="py-5 mx-auto">
                    <div className="max-w-[600px]">
                        <h1 className="text-3xl text-green-700">Sân Đặt: <span className="text-black font-bold uppercase">{thongTinSanDaDat?.name} - SÂN 1</span></h1>
                        <div className="text-center my-7">
                            <Image src="https://leethanh.netlify.app/image/sanThanhThang.JPG" className="h-[200px] border-4 border-gray-400 rounded-2xl" width={400} alt="" />
                        </div>
                        <h1 className="text-3xl text-green-700">Giờ Đặt: <span className="text-black font-bold bg-gray-200 py-1 px-2 rounded-2xl">{thongTinSanDaDat?.ocl1} - {thongTinSanDaDat?.ocl2} </span></h1>
                        <h1 className="text-3xl text-green-700 py-3">Địa Chỉ: <span className="text-black font-bold">{thongTinSanDaDat?.address}</span></h1>
                        <h1 className="text-3xl text-green-700 py-3">Số Điện Thoại Chủ Sân: <span className="text-black font-bold">0123456789</span></h1>
                    </div>
                </div>
                <div className="py-5">
                    <Form
